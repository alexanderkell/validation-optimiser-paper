...
We tried using the average value of each of the clusters, which we will refer to in this text as the ``centroids'' technique. We also tried choosing the day that was closest to the centroid by euclidean distance. This will be referred to in the rest of this text as the ``medoids'' technique.
...
The error metrics do not show a significant from using either the centroids or medoids technique. However, we chose to use the medoids technique as we believe this would more accurately model a single day.
