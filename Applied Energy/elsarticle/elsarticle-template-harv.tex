...
To verify the accuracy of ElecSim we used a genetic algorithm approach to find the optimum linear regression model that would best validate the results from 2013 to 2018.
